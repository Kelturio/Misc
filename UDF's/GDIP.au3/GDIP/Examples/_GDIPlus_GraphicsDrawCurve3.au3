...
Func _Example()
	...
	$hGUI = GUICreate("_GDIPlus_GraphicsDrawCurve3 Example", 400, 350)
	GUISetState()
	...
	; Draw the curve specifying the number of points to use, the offset of the first point and a tension value
	; Start from the second point and use only 3 points to draw th curve
	_GDIPlus_GraphicsDrawCurve3($hGraphics, $aPoints, 1, 3, 0.8, $hPen)
	; Start from the sixth point and uee only 3 points to draw the curve
