...
Global Const $sAET_CLASSNAME = 'AutoItErrorTrap_ID_' & Random(100, 1000, 1)
;================================================================================================================================
#Tidy_On
...
Func __AET_MainWindow()
	Local $aiMem = ProcessGetStats(), $aiIOs = ProcessGetStats(-1, 1), $sMoreInfo
	Local $tWCEX, $tClass, $hIcon, $hLeftIcon, $hFont
...
Func __AET_ShutDown()
	If $hAET_CBTPROC_HOOKERROR Then
		...
		DllCallbackFree($hAET_CBTPROC_CALLBKERROR)
		;----> Clean up resources used by Microsoft Windows GDI+.
		If $hAET_SCR_HBITMAP Then _WinAPI_DeleteObject($hAET_SCR_HBITMAP)
		_GDIPlus_Shutdown()
		;<----
	EndIf
